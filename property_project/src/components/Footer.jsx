...
  return (
    <footer id="footer" className="bg-gray-800 text-gray-300 py-12 md:py-20"> {/* Menggunakan bg-gray-800 untuk tampilan yang lebih umum di footer multi-kolom */}
      <div className="container mx-auto px-6">
        {/* Bagian Atas Footer: Logo dan Deskripsi Singkat */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8"> {/* Menggunakan grid untuk layout multi-kolom */}
          {/* Kolom 1: Logo & Deskripsi Utama */}
...
            />
            <p className="text-xl sm:text-2xl font-bold tracking-tight text-white mb-2 drop-shadow-md"> {/* Warna teks jadi putih */}
              Sarolangun Properti
            </p>
            <p className="text-sm leading-relaxed text-gray-400"> {/* Deskripsi baru */}
...
              <li><a href="https://wa.me/6281373381797" className="text-gray-300 hover:text-white hover:underline transition-colors duration-300">Daftar Jadi Agen</a></li> {/* Diubah dari Karir */}
            </ul>
          </div>

          {/* Kolom 4: Hubungi Kami & Ikon Sosial */}
          <div className="text-center md:text-left">
...
                <FaWhatsapp className="text-teal-400 text-xl flex-shrink-0" />
                <span>+6281373381797</span>
              </a>
            </address>

            {/* Ikon Sosial di bawah Hubungi Kami */}
